        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3 pt-2">
            <a
              ...
              className="p-2.5 bg-white border border-zinc-300 hover:border-black text-zinc-800 hover:text-black transition-colors shadow-2xs"
              aria-label="VIA Instagram"
            >
